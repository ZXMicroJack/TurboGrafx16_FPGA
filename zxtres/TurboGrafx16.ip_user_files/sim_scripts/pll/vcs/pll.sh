...
#
# Generated by Vivado on Sun Nov 03 00:03:07 GMT 2024
...
# Script info
echo -e "pll.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../TurboGrafx16.gen/sources_1/ip/pll/pll_clk_wiz.v" \
    "$ref_dir/../../../../TurboGrafx16.gen/sources_1/ip/pll/pll.v" \
  2>&1 | tee -a vlogan.log
